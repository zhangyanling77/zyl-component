...
export const APPEARANCES: AppearencesObj = {
  primary: "primary",
...
export const btnPadding: { small: string; medium: string; large: string; } = {
  small: "0 7px",
  medium: "4px 15px",
  large: "6.4px 15px",
};
...
export const StyledButton = styled.button<ButtonProps>`
  ...
  overflow: hidden;
  padding: ${(props) =>
    props.size === SIZES.small ? "0 7px" : props.size === SIZES.medium ? "4px 15px" : "6.4px 15px"
  };
  position: relative;
  text-align: center;
  text-decorator: none;
  ...
  font-size: ${(props) =>
    props.size === SIZES.small ? typography.size.s1 : props.size === SIZES.medium ? typography.size.s2 : typography.size.s3
  };
